...
const GenderScreen = ({navigation}) => {
  ...
  const buttonColor =
    gender === 'WOMEN' || gender === 'MEN' || gender === 'OTHER'
    ...
    <SafeAreaView style={styles.SafeAreaMain}>
      <View style={styles.Viewmain}>
        ...
        <View style={styles.i_Am_A_Text_Container}>
          <Text style={styles.i_Am_A_Text_style}>I am a</Text>
        </View>
        <View style={{flex: 1, justifyContent: 'space-evenly'}}>
          <TouchableOpacity
            onPress={() => onPressGender('WOMEN')}
            style={[
              [
                styles.GenderSelectBtn,
                {backgroundColor: gender === 'WOMEN' ? '#E94957' : 'white'},
              ],
            ]}>
            <Text
              style={[
            ...
            <Image
              source={
                gender === 'WOMEN'
                  ? require('../../pictures/check1.png')
                  : require('../../pictures/check.png')
              }
            />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => onPressGender('MEN')}
            style={[
              [
                styles.GenderSelectBtn,
                {backgroundColor: gender === 'MEN' ? '#E94957' : 'white'},
              ],
            ]}>
            <Text
              style={[
          ...
          <TouchableOpacity
            onPress={() => onPressGender('OTHER')}
            style={[
              [
                styles.GenderSelectBtn,
                {backgroundColor: gender === 'OTHER' ? '#E94957' : 'white'},
              ],
            ]}>
            <Text
              style={[
