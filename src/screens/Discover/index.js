...
const Cards = [
  {
    Image: require('../../pictures/virat.jpeg'),
    id: 1,
    title: 'Virat kohli',
    age: '33',
  },
  {
    Image: require('../../pictures/sp.jpeg'),
    id: 2,
    title: 'spider man',
    age: '25',
  },
  {
    Image: require('../../pictures/anadearmas.jpeg'),
    id: 3,
    title: 'Ana de armas',
    age: '33',
  },
  {
    Image: require('../../pictures/sourabh.jpeg'),
    id: 4,
    title: 'Sourabh singh',
    age: '20',
  },
  {
    Image: require('../../pictures/ronaldo.jpeg'),
    id: 5,
    title: 'ronaldo',
    age: '35',
  },
  {
    Image: require('../../pictures/prinka.jpeg'),
    id: 6,
    title: 'Priyanka',
    age: '35',
  },
  {
    Image: require('../../pictures/modiji.jpeg'),
    id: 7,
    title: 'modi ji',
    age: '68',
  },
  ...
  {
    Image: require('../../pictures/dr.strange.jpeg'),
    id: 9,
    title: 'Dr.Strang',
    age: '45',
  },
  {
    Image: require('../../pictures/thor.jpeg'),
    id: 10,
    title: 'Thor',
    age: '40',
  },
...
const Discover = ({navigation}) => {
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderMove: (_, {dx, dy}) => {
      console.log('dx:' + dx + 'dy:' + dy, 'start');
      swipe.setValue({x: dx, y: dy});
    },
    onPanResponderRelease: (_, {dx, dy}) => {
      console.log('release' + 'dx:' + dx + 'dy:' + dy, 'end');
          ...
          <View>
            <BottomSheet
              ...
              <ScrollView
                ...
                <View style={styles.filterAndClearView}>
                ...
                <View style={styles.IntrestedInTextView}>
                  <Text style={styles.IntrestedInTextstyle}>Interested in</Text>
                </View>
                <View style={styles.GendersViewStyle}>
                  <TouchableOpacity
                ...
                <View style={{}}>
                  <TouchableOpacity
                    ...
                    <View style={styles.SelectLocationTouchableViewStyle}>
                      <View style={{left: 7}}>
                        <Text style={styles.SelectLocationTouchableTextStyle}>
                          {location}
                        </Text>
                      </View>
                      {isClicked ? (
                        <AntDesign name="down" color="#E94957" size={25} />
                      ) : (
                        <AntDesign name="up" color="#E94957" size={25} />
                      )}
                    </View>
                  </TouchableOpacity>
                  ...
                  <View style={styles.AllSlidersMainView}>
                    <View style={styles.DistanceAndValueView}>
                      ...
                      <Text style={styles.DistanceValueTextStyle}>
                        {Math.floor(range * 70)}km
                      </Text>
                    </View>
                    <Slider
                    ...
                    <View style={styles.MaximumAgeAndValueView}>
                      <Text style={styles.MaximumAgeTextStyle}>
                        Maximum Age
                      </Text>
                      <Text style={styles.MaximumAgeValueTextStyle}>
                        {Math.floor(maximumAge * 70)}
                      </Text>
                    </View>
                    <Slider
                      thumbTintColor="#E94957"
